...
const resetPasswordLinkTemplate = (user, token) => {
  return ({
    ...
    <body style="padding: 0 20px;background: rgb(236,236,236);margin: auto;">
      <div class='handle-class' style="background-color: #fff;max-width: 612px;margin: auto;">
        ...
        <div style='text-align: center;padding: 0 50px;' class="font-family-quicksand">
          ...
          <div style='text-align: center;' class="description-font-style">You have requested for reset password. Please click on <a href="${config.get('clientEndpoint')}/reset-password?token=${token}">Reset password</a> to change your password </div>
          ...
          <div style='text-align: center; font-size: 14px' class="description-font-style">${config.get('clientEndpoint')}/reset-password?token=${token}</div>
          <br/>
...
module.exports = { resetPasswordLinkTemplate };